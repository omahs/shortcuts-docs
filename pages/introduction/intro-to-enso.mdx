...
Enso financial infrastructure for developers that wish to develop, embed, or utilize DeFi interactions through their application.  Whether this may be a wallet, smart wallet, exchange, defi interface aggregator, router, or any other financial application. Enso provides the tools to execute and fetch all relevant metadata of DeFi protocols enabling developers to build the next generation of financial applications.
