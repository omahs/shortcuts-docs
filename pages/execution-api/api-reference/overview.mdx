...
Learn more about the different endpoints of Swap API:
    ...
    POST /v1/shortcuts/bundle - Build a shortcut from multiple contract calls, allow to manually specify contract calls. Returns a transaction that can be submitted to an Ethereum node.
