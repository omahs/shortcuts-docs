...
| `tokenInAmountToTransfer` | (Optional) If entering with EOA, Amount of tokenIn (Ether) that needs to be approved to the wallet before the transaction in wei | tokenInAmountToTransfer = 100000000000 |
