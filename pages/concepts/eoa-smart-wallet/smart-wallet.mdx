...
Applications that enable Smart Wallets to interact with their platform or are an application leveraging Smart Wallets can utilize Enso for all [Tokenized Interactions](../background/tokenizedVsNonTokenized/tokenized.mdx) and [Non-Tokenized Interactions](../background/tokenizedVsNonTokenized/nonTokenized.mdx).
